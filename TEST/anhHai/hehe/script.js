...
const renderUser = doc => {
  const tr = `
    <tr data-id='${doc.id}'>
      ...
      <td>
        <button hidden class="btn btn-edit">Add</button>
        <button class="btn btn-edit-info">Edit Info</button>
      </td>
    </tr>
  `;
...
const renderCourse = doc => {
  const tr = `
    <tr data-id='${doc.id}'>
      ...
      <td>${doc.data().mark}</td>
      <td>
      <button hidden class="btn btn-edit-course">Edit</button>
      <button disabled class="btn btn-delete-course">Delete</button>
      </td>
    </tr>
  `;
